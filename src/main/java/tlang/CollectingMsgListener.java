 ...
 */
private static final Pattern nonWhiteSpace = notNull(Pattern.compile("[^\\h\\v]"));
 /* Implementation note:
...
{ msg = (msg != null) ? msg : "";
  @SuppressWarnings("null") String program = programName(recognizer);
...
private static String programName(Recognizer<?, ?> recognizer) {
  String program;
...
/**
 * <strong><em>To only be used when the item is known to be non-null.</em></strong> Using this
