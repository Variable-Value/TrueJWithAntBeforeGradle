...
Scenario: A final value defined with one decoration cannot be used with the other
  ...
  When an invalid run unit is
   ...
   Then the following are in the error messages
    """
    line 8:6 for <startingA'>: startingA' does not use the decoration that was defined at line 6
    line 11:6 for <a'>: a' does not use the decoration that was defined at line 7
    """
  ...
  Then the following are in the error messages
    """
    line 8:7 for <startingA>: startingA does not use the decoration that was defined at line 6
    line 9:26 for <a>: a does not use the decoration that was defined at line 7
    """
  ...
  When an invalid run unit is
   ...
   Then the following are in the error messages
    """
    line 8:6 for <startingB>: startingB does not use the decoration that was defined at line 5
    line 9:6 for <startingA'>: startingA' does not use the decoration that was defined at line 4
    """
  ...
  When An invalid run unit is
   ...
   Then the following are in the error messages
    """
    line 7:2 for <a'>: a' does not use the decoration that was defined at line 6
    line 8:2 for <b>: The value b has already been defined on line 3
    line 9:2 for <c>: c does not use the decoration that was defined at line 3
    ...
    Then the following are in the error messages
    """
    line 8:2 for <starting'>: starting' does not use the decoration that was defined at line 6
    """
  ...
  When An invalid run unit is
    ...
    Then the following are in the error messages
    """
    23:6 for <a>: a does not use the decoration that was defined at line 19
    23:15 for <b'>: b' does not use the decoration that was defined at line 20
    """
